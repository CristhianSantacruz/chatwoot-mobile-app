...
describe('findConversationLinkFromPush', () => {
  it('should return conversation link if notification_type is conversation_creation', () => {
    ...
    const installationUrl = 'https://chat2pay.navcloud.ec';
    ...
    expect(result).toBe(
      'https://chat2pay.navcloud.ec/app/accounts/1/conversations/14428/14902/Conversation',
    );
  });
  ...
  it('should return conversation link if notification_type is assigned_conversation_new_message', () => {
    ...
    expect(result).toBe(
      'https://chat2pay.navcloud.ec/app/accounts/1/conversations/14429/58731/Message',
    );
  });
  ...
  it('should return conversation link if notification_type is conversation_mention', () => {
    ...
    expect(result).toBe(
      'https://chat2pay.navcloud.ec/app/accounts/1/conversations/14428/58725/Message',
    );
  });
  ...
  it('should return conversation link if notification_type is participating_conversation_new_message', () => {
    ...
    expect(result).toBe(
      'https://chat2pay.navcloud.ec/app/accounts/1/conversations/14427/58712/Message',
    );
  });
